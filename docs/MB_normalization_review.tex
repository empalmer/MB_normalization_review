...
\includegraphics{MB_normalization_review_files/figure-latex/unnamed-chunk-2-1.pdf}
...
\includegraphics{MB_normalization_review_files/figure-latex/unnamed-chunk-9-1.pdf}
...
\includegraphics{MB_normalization_review_files/figure-latex/unnamed-chunk-10-3.pdf}
...
\subsubsection{CSS on Global Patterns}\label{css-on-global-patterns}}
...
\hypertarget{compositionality-aware-scaling-methods}{%
\chapter{Compositionality Aware Scaling Methods}\label{compositionality-aware-scaling-methods}}
...
\label{tab:unnamed-chunk-16}Step 1: Logged Raw Counts
...
\caption{\label{tab:unnamed-chunk-17}Step 2: Average Logged Counts}
\centering
\begin{tabular}[t]{l|r}
\hline
...
\caption{\label{tab:unnamed-chunk-18}Step 3: Log Ratio of reads in each sample to average across all samples}
\centering
...
\caption{\label{tab:unnamed-chunk-19}Step 4: Calculating medians per sample}
\centering
...
\label{tab:unnamed-chunk-20}Step 5: DESeq Normalized Counts
...
\includegraphics{MB_normalization_review_files/figure-latex/unnamed-chunk-22-1.pdf}
...
\includegraphics{MB_normalization_review_files/figure-latex/unnamed-chunk-23-1.pdf}
...
\includegraphics{MB_normalization_review_files/figure-latex/unnamed-chunk-23-2.pdf}
...
\label{tab:unnamed-chunk-24}Example dataset - Raw Counts
...
\label{tab:unnamed-chunk-25}Example dataset - Raw Counts
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{norm\_GMPR \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(ps, }\DataTypeTok{intersect\_no =} \DecValTok{4}\NormalTok{, }\DataTypeTok{min\_ct =} \DecValTok{2}\NormalTok{)\{}
  \KeywordTok{require}\NormalTok{(GMPR, }\DataTypeTok{quietly =}\NormalTok{ T)}
    \CommentTok{\# Convert data to correct format for GMPR function }
...
\NormalTok{    otu.tab \textless{}{-}}\StringTok{ }\KeywordTok{matrix}\NormalTok{(otu, }\DataTypeTok{ncol =} \KeywordTok{ncol}\NormalTok{(otu))}
    \CommentTok{\# calculate scaling factor}
    \CommentTok{\# OTU matrix must be a data frame where OTUs are arranged in columns and samples as rows}
\NormalTok{    gmpr.size.factor \textless{}{-}}\StringTok{ }\NormalTok{GMPR}\OperatorTok{::}\KeywordTok{GMPR}\NormalTok{(}\DataTypeTok{OTUmatrix =}\NormalTok{ otu\_df,}
                                   \DataTypeTok{intersect\_no =}\NormalTok{ intersect\_no,}
                                   \DataTypeTok{min\_ct =}\NormalTok{ min\_ct)}
    \CommentTok{\# normalize}
\NormalTok{    otu.tab.norm \textless{}{-}}\StringTok{ }\KeywordTok{t}\NormalTok{(otu }\OperatorTok{/}\StringTok{ }\NormalTok{(gmpr.size.factor))}
    \CommentTok{\# convert back to PS}
\NormalTok{    otu\_ps \textless{}{-}}\StringTok{ }\KeywordTok{otu\_table}\NormalTok{(otu.tab.norm, }\DataTypeTok{taxa\_are\_rows =}\NormalTok{ T)}
\NormalTok{    sam \textless{}{-}}\StringTok{ }\KeywordTok{access}\NormalTok{(ps, }\StringTok{"sam\_data"}\NormalTok{)}
\NormalTok{    sam}\OperatorTok{$}\NormalTok{scaling\_factor \textless{}{-}}\StringTok{ }\NormalTok{gmpr.size.factor}
\NormalTok{    tax \textless{}{-}}\StringTok{ }\KeywordTok{access}\NormalTok{(ps, }\StringTok{"tax\_table"}\NormalTok{)}
\NormalTok{    phy \textless{}{-}}\StringTok{ }\KeywordTok{access}\NormalTok{(ps, }\StringTok{"phy\_tree"}\NormalTok{)}
\NormalTok{    ps\_GMPR \textless{}{-}}\StringTok{ }\KeywordTok{phyloseq}\NormalTok{(otu\_ps,sam,tax,phy)}
...
\includegraphics{MB_normalization_review_files/figure-latex/unnamed-chunk-26-1.pdf}
...
\includegraphics{MB_normalization_review_files/figure-latex/unnamed-chunk-26-2.pdf}
...
\includegraphics{MB_normalization_review_files/figure-latex/unnamed-chunk-26-3.pdf}
...
\includegraphics{MB_normalization_review_files/figure-latex/unnamed-chunk-27-1.pdf}
...
\includegraphics{MB_normalization_review_files/figure-latex/unnamed-chunk-30-1.pdf}
...
\includegraphics{MB_normalization_review_files/figure-latex/unnamed-chunk-31-1.pdf}
...
\label{tab:unnamed-chunk-32}Example dataset - Raw Counts
...
\caption{\label{tab:unnamed-chunk-34}Rarefied counts}
\centering
\begin{tabular}[t]{l|r|r}
\hline
...
\includegraphics{MB_normalization_review_files/figure-latex/unnamed-chunk-36-1.pdf}
...
\includegraphics{MB_normalization_review_files/figure-latex/unnamed-chunk-36-2.pdf}

\hypertarget{other-methods}{%
\chapter{Other Methods}\label{other-methods}}

\hypertarget{wrench}{%
\section{Wrench}\label{wrench}}
...
\chapter{Log Ratio Transformation Methods}\label{log-ratio-transformation-methods}}
