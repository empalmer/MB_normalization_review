...
\includegraphics{MB_normalization_review_files/figure-latex/unnamed-chunk-34-1.pdf}
...
\hypertarget{log-ratio-transformation-methods-1}{%
\chapter{Log Ratio Transformation Methods}\label{log-ratio-transformation-methods-1}}
